...
overall.transfer_model_object = KazemiTwoPhaseTransferFunction('LimAzizShapeFactor',...
                                                                 [10,10,10]);
natural.transfer_model_object = KazemiTwoPhaseTransferFunction('LimAzizShapeFactor',...
                                                                 [10,10,10]);
%% Initializing state
